        ...
        def guineverego():
            ...
            for line in file5:
                ...
                if username == data[0] and newpassword == data[1]:
                    ...
                    file.close()
                    e = Gtb1.get()
                    os.rename(e+".py",e+"temp.txt")
                    os.rename(e+"temp.txt",e+".txt")
                    file = open(e+".txt","r")
                    file = open(e+".txt","r")
